...
final RegExp rangeExpression = RegExp('[a-zA-Z]+[0-9]+:[a-zA-Z]+[0-9]+\W+');
                  ...
                  SizeTransition(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Container(margin: EdgeInsets.symmetric(vertical: 10),  width: 1, color: Colors.grey, height: MediaQuery.of(context).size.height / 5 + 170,),
                          Container(
                                ...
                                itemBuilder: (context, index){
                                  return TextFormField(
                                                        ...
                                                        decoration: InputDecoration(
                                                          ...
                                                          hintStyle: TextStyle(fontSize: 20, color: Color(0xFF8B93A2)),
                                                        ),
                                                        maxLength: 20,
                                                        style: TextStyle(fontSize: 20, color: Color(0xFFB7BCC5)),
                                                        onTap: (){
                  ...
                  SizeTransition(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Container(margin: EdgeInsets.symmetric(vertical: 10),  width: 1, color: Colors.grey, height: MediaQuery.of(context).size.height / 5 + 180,),
                          Container(
                            padding: EdgeInsets.fromLTRB(10, 10, 0, 0),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Text("First Group Range", style: TextStyle(color: Color(0xFFB7BCC5), fontSize: 25),),
                              Container(padding: EdgeInsets.fromLTRB(0, 0, 0, 10),),
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("Data Repeats", style: TextStyle(color: Color(0xFFB7BCC5), fontSize: 25),),
                                    TextFormField(
                                    ...
                                    RadioListTile<AutomaticImport>(
                                      title: Text("Vertical", style: TextStyle(color: Color(0xFFB7BCC5), fontSize: 20),),
                                      value: AutomaticImport.vertical,
                                      groupValue: _modeSelected2,
                                      onChanged: (AutomaticImport value){
                                        setState(() {
                                    ...
                                    RadioListTile<AutomaticImport>(
                                      title: Text("Horizontal", style: TextStyle(color: Color(0xFFB7BCC5), fontSize: 20),),
                  ...
                  Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: Text("Import", style: TextStyle(color: Color(0xFFB7BCC5), fontSize: 20),),
                                          onPressed: (){},
                                          style: ButtonStyle(
                                            shape: MaterialStateProperty.all<OutlinedBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                                            backgroundColor: MaterialStateProperty.all<Color>(Color(0xFF363A43))
                                          ),
                                        ),
                                        )
                                      ],
