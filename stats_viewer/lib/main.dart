  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: Icon(Icons.grid_on), onPressed: ()=> {}, iconSize: 25,),
          IconButton(icon: Icon(Icons.settings), onPressed: ()=> {}, iconSize: 25,),
        ],
        elevation: 0,
      ),
      body: Column(
          ...
          children: <Widget>[
            ...
            Column(
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.info, color: Color(0xFF515151),),
